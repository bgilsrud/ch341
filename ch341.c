 ...
 * Copyright 2016, Ben Gilsrud <bgilsrud@gmail.com>
 *
		...
		struct usb_serial_port *port, struct ktermios *old_termios)
{
	...
	/* Parity, stop, and word length bits were determined by snooping USB 
	 * traffic from a windows VM. Unsurprisingly, the LCR uses the same 
	 * layout as a 16550.
	 */
	...
	if ((old_termios->c_cflag & (CSIZE|PARODD|PARENB|CMSPAR|CSTOPB)) !=
		...
		ch341_control_out(port->serial->dev, CH341_REQ_WRITE_REG,
				CH341_REG_LCR, lcr);
	}
}
